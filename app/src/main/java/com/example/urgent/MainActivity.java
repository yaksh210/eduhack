...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendLoc=findViewById(R.id.send);
        ...
        sendLoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                intent.putExtra("latt",lattitude.getText().toString());
                intent.putExtra("lon",longitude.getText().toString());
                intent.putExtra("add",address.getText().toString());
                intent.putExtra("city",city.getText().toString());
                intent.putExtra("cou",country.getText().toString());
